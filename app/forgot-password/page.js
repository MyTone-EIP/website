      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: windowWidth <= 1000 ? '30px' : '40px' }}>
          ...
          <p style={{ color: '#888', margin: 0, fontSize: windowWidth <= 1000 ? '13px' : '14px' }}>
            {t.forgotPasswordTitle || 'Réinitialiser votre mot de passe'}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: windowWidth <= 1000 ? '15px' : '20px' }}>
            ...
            <input
              ...
              placeholder={t.enterEmail || 'Entrez votre adresse email'}
            />
          </div>

          <p style={{ color: '#888', fontSize: windowWidth <= 1000 ? '12px' : '13px', marginBottom: windowWidth <= 1000 ? '15px' : '20px', marginTop: '10px' }}>
            {t.forgotPasswordDescription || 'Entrez votre adresse email et nous vous enverrons un lien pour réinitialiser votre mot de passe.'}
          </p>
          ...
          >
            {loading ? (t.sending || 'Envoi...') : (t.sendResetLink || 'Envoyer le lien de réinitialisation')}
          </button>
        </form>
